...
let publications = [
  {
    ...
    subtitle:
      "This is how I career changed to frontend development at 40, starting with no relevant background experience or degree. Using only self-directed study while working full-time and spending next to nothing.",
    image: {
  ...
  {
    title: "The tools and resources that landed me a frontend developer job",
    subtitle:
      "Learning frontend development can be a bit overwhelming at times. There are so many resources and tools, and so little time. What should you pick? And what should you focus on?",
    image: {
